...
masked_data = masked_values(disasters_data, value=None)
...
with Model() as model:
    ...
    # Data likelihood
    disasters = Poisson('disasters', rate, observed=masked_data)
...
def run(n=1000):
    ...
    with model:
        ...
        # Use Metropolis for switchpoint and missing data
        step2 = Metropolis([switchpoint, disasters])
